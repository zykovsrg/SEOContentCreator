...
- [x] **Step 2: Implement `ImageClient`**
...
- [x] **Step 2: Add a label-based init + title mapping**
...
- [x] **Step 2: Implement `ImageGenerator`**
...
- [x] **Step 2: Compile.** Run the build command from the header. Expected: `** TEST BUILD SUCCEEDED **`.
